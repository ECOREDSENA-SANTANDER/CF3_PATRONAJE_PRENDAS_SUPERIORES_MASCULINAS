  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-8(data-aos="fade-right")
        ...
        p Bajo esta metodología, cada tipología se aborda de manera específica: el trazo de la camiseta polo incorpora líneas rectas y canesú frontal; la sudadera deportiva requiere refuerzos en hombros y puños; la camisa de manga corta con cuello deportivo equilibra estructura y ligereza; la camisa con canesú delantero y trasero explora planos superpuestos; y las chaquetas, desde la sastre (con líneas sobrias y cortes entallados) hasta la #[em bomber] (de perfil amplio) y el #[em denim] tipo Levi´s (con costuras expuestas y bolsillos de parche), ilustran cómo un mismo concepto base puede transformarse en múltiples expresiones del vestir casual masculino.
